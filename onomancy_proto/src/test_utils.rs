...
/// construction.
#[must_use]
pub fn rotation(doc_seed: u8, replaced_seed: u8, successor_seed: u8) -> RotationStatement {
...
/// `signer(signer_seed)`.
#[must_use]
pub fn succession(predecessor_seed: u8, successor_seed: u8, signer_seed: u8) -> SuccessorStatement {
